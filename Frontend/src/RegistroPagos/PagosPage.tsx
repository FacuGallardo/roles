...
.pagos-container { min-height: 100vh; background-color: #f3f4f6; padding: clamp(0.75rem, 2vw, 1rem); margin-top: 0; }
@media (min-width: 768px) { .pagos-container { padding: clamp(1rem, 3vw, 2rem); margin-top: 0; } }
